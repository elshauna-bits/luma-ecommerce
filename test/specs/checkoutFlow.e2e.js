...
describe('Checkout Flow', ()=>{
   ...
   beforeEach(async()=> {
      ...
      await loginPage.login('kenriley@mail.com','P@$$w0rd@Yo#an');
    });
   it('should add a product to the cart & purchase', async()=>{
   ...
   xit('should verify purchase in order history',async ()=>{
      ...
      await expect(checkout.recentOrders).toHaveText(['Recent Orders']);
   });
